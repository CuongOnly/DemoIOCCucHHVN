...
export default function DBThuTucHanhChinh(props) {
      ...
      <div className="pageHomeDash" ref={(e) => {
        ...
        <div className="Container" ref={(e) => {
          ...
          <div className="containerDb">
            <div className="address">
              ...
              <FormControl>
                ...
                >
                  ...
                  <FormControlLabel value={"1"} control={<Radio />} label="Tổng hợp" />
                  <FormControlLabel value={"2"} control={<Radio />} label="Cổng thông tin một cửa quốc gia" />
                </RadioGroup>
              </FormControl>
            ...
            {groupChartTH === "1" ?
            <div style={{ width: "calc(100% - 50px)", margin: "0 auto", display: groupChartTH ? "block" : "none" }}>
                ...
                <Grid container spacing={1} columns={24}>
                  <Grid item xs={12}>
                    <Box fullWidth style={{ backgroundColor: "white", height: h + "px" }}>
                      <Chart jsonUrl={props.listUrls[4]} groupChartTH />
                    </Box>
                  </Grid>

                  <Grid item xs={12}>
                    <Box fullWidth style={{ backgroundColor: "white", height: h + "px" }}>
                      <Chart jsonUrl={props.listUrls[5]} />
                    </Box>
                  </Grid>

                  <Grid item xs={12}>
                    <Box fullWidth style={{ backgroundColor: "white", height: h + "px" }}>
                      <Chart jsonUrl={props.listUrls[6]} />
                    </Box>
                  ...
                  <Grid item xs={12}>
                    <Box fullWidth style={{ backgroundColor: "white", height: h + "px" }}>
                      ...
                      <Chart jsonUrl={props.listUrls[7]} />
                    </Box>
