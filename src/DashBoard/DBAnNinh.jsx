...
export default function DBAnNinh(props) {
        ...
        <div className="Container" ref={(e) => {
          ...
          <div className="containerDb">
            <div className="address">
              ...
              <FormControl>
                ...
                >
                  ...
                  <FormControlLabel value={"1"} control={<Radio />} label="Số liệu thống kê" />
                  <FormControlLabel value={"2"} control={<Radio />} label="So sánh giữa các năm" />
                </RadioGroup>
              </FormControl>
            ...
            <div style={{ width: "calc(100% - 50px)", margin: "0 auto", display: groupChartTH ? "block" : "none" }}>
                ...
                <Grid container spacing={1} columns={24}>
                  <Grid item xs={24}>
                    <Box fullWidth style={{ backgroundColor: "white", height: h*2 + "px" }}>
