...
export const portData = [
  { id: 1, name: 'KHU BẾN CÁI MÉP', img: "/images/cangbien/caimep-vungtau.jpg", top: 44.3, left: 35.5 },
  ...
  render() {
    ...
    return (
      <div className="container-fluid">
        <h4 style={{ color: "#00000A6", cursor: 'pointer' }} onClick={this.handleH4Click}>QUY HOẠCH BẾN CẢNG - VŨNG TÀU</h4>
        {selectedPort && (
        ...
        <div className="row">
          <div className="col">
            ...
            >
              <img
                className='imgHH'
                src={selectedPort ? selectedPort.img : "/imgs/vungtau.jpg"}
                alt="Thumbnail"
